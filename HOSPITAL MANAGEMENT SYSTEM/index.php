    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;">
                <h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp LIFE CARE HOSPITALS</h4>
            </a>
        ...
        <div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="row">
                <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%;">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-JGmDTLjVbkHk2YKLyc4yOEgIPahk0aJo4Q&usqp=CAU" alt="" />
                    <!-- <img src="https://image.ibb.co/n7oTvU/logo_white.png" alt=""/> -->
                    <h3 style="color:violet ;">Welcome to Life Care Hospital</h3>
